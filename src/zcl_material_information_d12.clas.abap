CLASS zcl_material_information_D12 DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
PUBLIC SECTION.
...
ENDCLASS.
CLASS zcl_material_information_D12 IMPLEMENTATION.
...
zcl_material_information_D12.
material_info = NEW zcl_material_information_D12( ).
